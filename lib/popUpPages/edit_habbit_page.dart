...
class EditHabbitPage extends StatefulWidget {
  const EditHabbitPage({super.key});

  @override
  State<EditHabbitPage> createState() => _EditHabbitPageState();
}

class _EditHabbitPageState extends State<EditHabbitPage> {
          ...
          children: [
            ...
            Row(
              children: [
                ...
                containerIcon(50, 50, FontAwesomeIcons.suitcase, 30),
                Spacer(),
              ],
            ),
            Container(
